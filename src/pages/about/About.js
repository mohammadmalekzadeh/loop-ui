...
export default function About() {
  return (
    <div
      className="relative h-screen bg-isabelline bg-center flex items-center justify-center px-6">

      {/* White transparent card */}
      <div className="relative max-w-2xl text-center bg-eggshell bg-opacity-70 p-10 rounded-2xl shadow-2xl">
        <img
        ...
        {/* Welcome line */}
        <h2 className="text-2xl font-semibold text-azul mb-6 right-farsi">
